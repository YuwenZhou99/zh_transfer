    ...
    for temp in temp_names:
        ...
        with open(file_path, 'a+') as file:
            ...
            if name == "google/mt5-small" or name == "google/mt5-large":
                ...
                model = AutoModelForMaskedLM.from_pretrained(name, return_dict_in_generate=True, output_scores=True,
            ...
            print(
                f"Model: {name}, Accuracy: {accuracy:.5f}, Average Perplexity (Good Sentences): {ave_ppl_good:.5f}, Average Perplexity (Bad Sentences): {ave_ppl_bad:.5f}\n")
            file.write(
                f"Model: {name}, Accuracy: {accuracy:.5f}, Average Perplexity (Good Sentences): {ave_ppl_good:.5f}, Average Perplexity (Bad Sentences): {ave_ppl_bad:.5f}\n")
